...
public class AdminDetailsPage extends BasePage {
	...
	// Element Locators
		...
		private static final String PASSWD = "//*[@id='main']/div[2]/section/div[1]/div[5]/div[3]/div[3]/div[1]/input";
		private static final String CONFIRM_PASSWD = "//*[@id='main']/div[2]/section/div[1]/div[5]/div[3]/div[3]/div[2]/input";
	    private static final String ANSWER = "//*[@id='main']/div[2]/section/div[1]/div[5]/div[3]/div[4]/div[2]/input";
	    private static final String SECURITYQ = "//*[@id='drpSecurityQuestion']";
	    private static final String NEXTSTEP = "//*[@id='main']/div[2]/section/div[1]/div[5]/div[3]/p/a[2]";
		
	public AdminDetailsPage(WebDriver driver) {
		super(driver);
	}
