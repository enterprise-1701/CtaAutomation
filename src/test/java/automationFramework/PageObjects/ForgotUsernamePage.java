...
public class ForgotUsernamePage extends BasePage {

	WebDriverWait wait = new WebDriverWait(driver, 90);

	// Element Locators
		private static final String EMAIL = "//*[@id='divSubmit']/div[3]/div[2]/div/input";	
		private static final String SUBMIT = "//*[@id='divSubmit']/p/a";
		private static final String CONFIRMATION = "//*[@id='main']/div[2]/section/div/div[2]/div/h1";
