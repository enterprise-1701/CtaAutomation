...
public class GroupAccountAddPaymentCC {
	...
	public void addCCPayment()throws Exception{
		...
		pPage.clickSaveCCInfo(driver);
		
		//edit account
		//pPage.clickEdit(driver);
		Utils.waitTime(3000);
		
		pPage.enterCCNumber(driver, Global.CC);
		pPage.enterName(driver, Global.CONTACT_NAME);
		pPage.selectMonth(driver);
		pPage.selectYear(driver);
		...
		Assert.assertEquals(cPage.getCC(driver), Global.CC_MASKED2);
		Assert.assertEquals(cPage.getName(driver), Global.CONTACT_NAME);
