...
public class AddThreeDayPassTest {
	...
	public void addThreeDayPass()throws ElementNotVisibleException, ElementNotFoundException, NoSuchElementException, Exception{
		...
		addPage.selectThreeDayPass(driver);
		addPage.clickNextStep(driver);
		Utils.waitTime(3000);
		
		AddPassReviewOrderPage revPage = new AddPassReviewOrderPage(driver);
		Assert.assertEquals(revPage.getCTADayPass(driver), "CTA 3-Day Pass");
