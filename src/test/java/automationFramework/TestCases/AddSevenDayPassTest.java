...
public class AddSevenDayPassTest {
	...
	public void addSevenDayPass()throws ElementNotVisibleException, ElementNotFoundException, NoSuchElementException, Exception{
		...
		addPage.selectSevenDayPass(driver);
		addPage.clickNextStep(driver);
		Utils.waitTime(3000);
		
		AddPassReviewOrderPage revPage = new AddPassReviewOrderPage(driver);
		Assert.assertEquals(revPage.getCTADayPass(driver), "CTA 7-Day Pass");
